...
namespace Homework_選課系統.Tests
{
    ...
    public class DataTests
    {
        ...
        {
            Assert.IsTrue(_data.AllCourses.Count() == 4);
            _data.AllCourses = null;
            Assert.IsTrue(_data.AllCourses.Count() == 37);
        }

        //測試爬蟲並將所有開課班級加入AllCourse
        [TestMethod()]
        public void AddDataToAllCourseTest()
        {
            _data.AllCourses = null;
            _dataPrivate.Invoke("AddDataToAllCourse");
            Assert.IsTrue(_data.AllCourses.Count() == 37);
        }
        ...
        [TestMethod()]
        public void AddListToBindingListTest()
        {
            BindingList<Course> allCourses = new BindingList<Course>() { _course4 };
            List<Course> addCourses = new List<Course>() { _course3, _course1 };
            allCourses = (BindingList<Course>)_dataPrivate.Invoke("AddListToBindingList", allCourses, addCourses);
        ...
        //測試成功呼叫Observer
        [TestMethod()]
        public void NotifyCourseObserverTest()
        {
            try
            {
        ...
        [TestMethod()]
        public void DeleteSameCourseTest()
        {
            Course course5 = new Course("5", "測試課堂名稱五", "1", "3.0", "測試老師五", "測試必選修", "測試助教五", "測試語言五", "測試備註五", "3", "資工三");
        ...
        //測試根據模式回傳不包括已選的班級
        [TestMethod()]
        public void GetUnchooseCourseTest()
        {
